...
- For me, the best way of learning is search for datasets on internet and work on them. Alternatively, I extact various textual and numerical data from online sources using Python's webscraping tools susch as Selenium and BeautifulSoup. The small sample of my webscraping project results can be found on my Kaggle page:  [Link to Kaggle Datasets](http://beridzeg45.pythonanywhere.com/) ![Kaggle Logo](https://www.kaggle.com/static/images/site-logo.svg)
